...
def getBirthdays(number_of_birthdays):
    ...
    for i in range(number_of_birthdays):
        #Assumption that we select days through one year so to eliminate leap year
...
surprisingly large. This program does a Monte Carlo simulation (that is, repeated random simulations) to explore this
concept.
