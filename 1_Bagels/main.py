""""Bagels - game taken from The Big Book of Small Python Projects
    ...
    while True:     #Main game loop
        ...
        while numGuesses <= MAX_GUESSES:
            ...
            while len(guess) != NUM_DIGITS or not guess.isdecimal():    #Keep looping until they enter a valid guess
                ...
                if guess == secretNum:
                    break #correct answear - break out the loop

                if numGuesses > MAX_GUESSES:
                    print("You ran out of guesses.")
                    print("The answear was: {}.".format(secretNum))
...
def getClues(guess, secretNum):
    ...
    if len(clues) == 0:
        ...
        #Sort the clues into alphabetical order - to give no specific information away
        clues.sort()
