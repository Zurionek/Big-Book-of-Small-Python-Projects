"""Dice Roller, by Al Sweigart
Simualtes dice rolls using the Dungeons & Dragons dice roll notation
"""
...
The format is the number of dice, followed by "d",
...
while True: #Main program loop
    try:
        ...
        #Clean up the dice string by removing spaces:
        ...
        #This is not mandatory element so lack of it does not
        #trigger any warning message
        ...
        for i in range(numberOfDice):
            rollsResult = random.randint(1, numberOfSides)
            rolls.append(rollsResult)
