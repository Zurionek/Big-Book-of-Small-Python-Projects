...
#We can't print to the last column on Windows without
#it adding a newline automatically, so reduce WIDTH by 1
WIDTH -= 1
...
try:
    #For each column, when the counter is 0, no stream is presented
    #Otherwise, it acts as a counter for how many times 1 or 0 should
    #be displayed in that column
    columns = [0] * WIDTH
    while True:
